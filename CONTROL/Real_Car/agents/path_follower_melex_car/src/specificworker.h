...
#include  "/home/robolab/robocomp/components/robocomp-pioneer/etc/pioneer_world_names.h"
...
//            float error_distance = 4000;
        ...
        float exponentialFunction2(float value, float xValue, float yValue, float min);

    float modify_rotation_value(float rot);
