...
public:
    ...
    {
        return _makeLamdaOutgoing<::RoboCompHumanCameraBody::PeopleData>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompHumanCameraBody::HumanCameraBodyPrx::_iceI_newPeopleData, context);
    }
