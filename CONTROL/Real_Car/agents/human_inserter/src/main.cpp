...
/** \mainpage RoboComp::human_inserter
 *
 * \section intro_sec Introduction
 *
 * The human_inserter component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/human_inserter --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class human_inserter : public RoboComp::Application
{
public:
	human_inserter (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::human_inserter::initialize()
{
...
int ::human_inserter::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(humancamerabody_proxy);
...
int main(int argc, char* argv[])
{
	...
	::human_inserter app(prefix, startup_check_flag);
