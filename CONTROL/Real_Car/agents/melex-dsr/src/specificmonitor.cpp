...
//	params["InnerModelPath"] = aux;
    ...
    configGetString( "","x", aux.value,"false");
    params["x"] = aux;
    configGetString( "","y", aux.value,"false");
    params["y"] = aux;
    configGetString( "","z", aux.value,"false");
    params["z"] = aux;
    configGetString( "","rx", aux.value,"false");
    params["rx"] = aux;
    configGetString( "","ry", aux.value,"false");
    params["ry"] = aux;
    configGetString( "","rz", aux.value,"false");
    params["rz"] = aux;
