...
//        void read_RSSI();
        ...
        std::vector<LaserPoint> read_laser_left_robot();
        std::vector<LaserPoint> read_laser_right_robot();
        std::vector<LaserPoint> read_laser_back_robot();
...
//        void update_rgbd();
        ...
        void update_camera_simple_usb();
        void update_three_camera();
        void update_left_camera();
        void update_right_camera();
        void update_back_camera();
        void update_robot_localization_gps();
