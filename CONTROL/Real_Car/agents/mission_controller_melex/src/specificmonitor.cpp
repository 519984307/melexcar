...
//	params["InnerModelPath"] = aux;
	...
	params["3d_view"] = aux;
    configGetString( "","route_filename", aux.value,"");
    params["route_filename"] = aux;
    configGetString( "","stop_1", aux.value,"");
    params["stop_1"] = aux;
    configGetString( "","stop_2", aux.value,"");
    params["stop_2"] = aux;
    configGetString( "","stop_3", aux.value,"");
    params["stop_3"] = aux;
    configGetString( "","stop_4", aux.value,"");
    params["stop_4"] = aux;
