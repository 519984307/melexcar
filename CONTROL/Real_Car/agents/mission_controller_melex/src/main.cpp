...
class mission_controller_melex : public RoboComp::Application
{
public:
	mission_controller_melex (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::mission_controller_melex::initialize()
{
...
int ::mission_controller_melex::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::mission_controller_melex app(prefix, startup_check_flag);
