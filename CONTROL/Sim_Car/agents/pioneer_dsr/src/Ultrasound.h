...
struct SonarPose
{
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const double&, const double&, const float&> ice_tuple() const
    {
...
public:
    ...
    {
        return _makeLamdaOutgoing<::RoboCompUltrasound::SensorsState>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getAllSensorDistances, context);
    }
    ...
    getAllSensorParamsAsync(::std::function<void(::RoboCompUltrasound::SensorParamsList)> response,
                            ...
                            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompUltrasound::SensorParamsList>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getAllSensorParams, context);
    }
    ...
    getAllSonarPoseAsync(::std::function<void(::RoboCompUltrasound::SonarPoseList)> response,
                         ...
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompUltrasound::SonarPoseList>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getAllSonarPose, context);
    }
    ...
    getBusParamsAsync(::std::function<void(::RoboCompUltrasound::BusParams)> response,
                      ...
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompUltrasound::BusParams>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getBusParams, context);
    }
    ...
    getSensorDistanceAsync(const ::std::string& sensor,
                           ...
                           const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<int>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getSensorDistance, sensor, context);
    }
    ...
    getSensorParamsAsync(const ::std::string& sensor,
                         ...
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompUltrasound::SensorParams>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getSensorParams, sensor, context);
    }
    ...
    getSonarsNumberAsync(::std::function<void(int)> response,
                         ...
                         const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<int>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompUltrasound::UltrasoundPrx::_iceI_getSonarsNumber, context);
    }
