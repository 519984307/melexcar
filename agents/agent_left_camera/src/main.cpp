...
/** \mainpage RoboComp::agent_left_camera
 *
 * \section intro_sec Introduction
 *
 * The agent_left_camera component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_left_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_left_camera : public RoboComp::Application
{
public:
	agent_left_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::agent_left_camera::initialize()
{
...
int ::agent_left_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_left_camera app(prefix, startup_check_flag);
