...
/** \mainpage RoboComp::agent_usb_camera
 *
 * \section intro_sec Introduction
 *
 * The agent_usb_camera component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_usb_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_usb_camera : public RoboComp::Application
{
public:
	agent_usb_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::agent_usb_camera::initialize()
{
...
int ::agent_usb_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_usb_camera app(prefix, startup_check_flag);
