...
/** \mainpage RoboComp::agent_back_camera
 *
 * \section intro_sec Introduction
 *
 * The agent_back_camera component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_back_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_back_camera : public RoboComp::Application
{
public:
	agent_back_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::agent_back_camera::initialize()
{
...
int ::agent_back_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_back_camera app(prefix, startup_check_flag);
