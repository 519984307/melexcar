...
/** \mainpage RoboComp::monitor_dsr
 *
 * \section intro_sec Introduction
 *
 * The monitor_dsr component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/monitor_dsr --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class monitor_dsr : public RoboComp::Application
{
public:
	monitor_dsr (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::monitor_dsr::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::monitor_dsr app(prefix, startup_check_flag);
