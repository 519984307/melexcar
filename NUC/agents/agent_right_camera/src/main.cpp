...
/** \mainpage RoboComp::agent_right_camera
 *
 * \section intro_sec Introduction
 *
 * The agent_right_camera component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_right_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_right_camera : public RoboComp::Application
{
public:
	agent_right_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::agent_right_camera::initialize()
{
...
int ::agent_right_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_right_camera app(prefix, startup_check_flag);
