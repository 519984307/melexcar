...
/** \mainpage RoboComp::agent_control
 *
 * \section intro_sec Introduction
 *
 * The agent_control component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_control --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_control : public RoboComp::Application
{
public:
	agent_control (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::agent_control::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_control app(prefix, startup_check_flag);
