...
private:
    ...
    struct CONSTANTS
    {
        ...
        int MAX_LASER_BINS = 116;  // 2 for each degrees
        float TOTAL_HOR_ANGLE = 116*M_PI/180;  // D455 opens 87 x 58 degrees
    ...
    void update_two_camera_node(string camera_name, const cv::Mat &v_image, const vector<uchar> compressed_data);
