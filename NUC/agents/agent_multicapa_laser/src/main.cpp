...
/** \mainpage RoboComp::agent_three_cameras
 *
 * \section intro_sec Introduction
 *
 * The agent_three_cameras component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agent_three_cameras --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agent_three_cameras : public RoboComp::Application
{
public:
	agent_three_cameras (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::agent_three_cameras::initialize()
{
...
int ::agent_three_cameras::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::agent_three_cameras app(prefix, startup_check_flag);
